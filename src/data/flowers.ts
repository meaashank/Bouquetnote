...
export const FLOWERS: Flower[] = [
  ...
  },
  {
    ...
    svgType: 'hydrangea',
    defaultScale: 1.2,
    description: 'Generous cloud of delicate florets creating voluminous soft texture and rich presence.',
    price: 15,
    meaning: ['Gratitude', 'Abundance', 'Heartfelt Emotion'],
    birthMonth: 'July',
    symbolism: 'Heartfelt understanding & gratitude',
    bestFor: ['Thank You', 'Appreciation', 'Homecoming', 'Celebration'],
    moods: ['thank-you', 'admiration', 'happiness'],
    colors: ['Sky Blue', 'Dusty Rose', 'Antique Mauve'],
    whyChoose: 'Hydrangeas express sincere gratitude and emotional abundance with their generous rounded clusters of soft petals.',
    colorMeanings: [
      { color: 'Blue', meaning: 'Deep gratitude & heartfelt honesty' },
      { color: 'Pink', meaning: 'Gentle emotion & genuine affection' }
    ]
  },
  {
  ...
  },
  {
    ...
    svgType: 'mimosa',
    defaultScale: 0.85,
    description: 'Playful sunny clusters of golden pollen puffballs spreading joyful light.',
    price: 7,
    meaning: ['Sensibility', 'Joy', 'Secret Love'],
    symbolism: 'Radiant warmth & affectionate joy',
    bestFor: ['Friendship', 'Celebration', 'Spring Awakening'],
    moods: ['happiness', 'friendship', 'birthday'],
    colors: ['Sun Gold'],
    whyChoose: 'Golden mimosa puffs infuse delicate airy sparkles and sunshine into the crown of any bouquet.'
  },
  {
    id: 'babysbreath-star',
    name: "Baby's Breath",
    ...
    svgType: 'babysbreath',
    defaultScale: 0.85,
    description: 'Airy cloud of tiny starry florets that weave softness between larger blooms.',
    price: 6,
    meaning: ['Everlasting Love', 'Purity', 'Freedom'],
    symbolism: 'Gentle innocence & soft connection',
    bestFor: ['Wedding', 'Romance', 'Sympathy', 'Soft Accent'],
    moods: ['love', 'sympathy', 'friendship'],
    colors: ['Starlight White'],
    whyChoose: "Baby's breath softens transitions and introduces an ethereal, atmospheric mist around bolder blossoms."
  },
  {
